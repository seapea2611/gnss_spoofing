...
if IS_CLOCK2 == 0:
    ...
    nav_file_01 = "DATA\external\D2025_03_13\96810723\96810723.25N"
    observation_file_01 = "DATA\external\D2025_03_13\96810723\96810723.25O"
    ...
    observation_file_02 = "DATA\external\D2025_03_13\89680723\IGS000USA_R_20250720850_01D_01S_MO.rnx"
...
#Đọc file Observation
#Rinex 3.02
obs_data_01 = read_rinex_observation_NGUYENDS(observation_file_01, IS_CLOCK2)
obs_data_02 = read_rinex_observation_NGUYENDS(observation_file_02, IS_CLOCK2)
...
print('read_rinex_3.02')
print(obs_data_01[0:32])

obs_data_01_smooth = carrier_smoothing_NDS2(obs_data_01)
obs_data_02_smooth = carrier_smoothing_NDS2(obs_data_02)
...
merged_smoothed_data_3x = pd.merge(obs_data_01, obs_data_02, on=['epoch', 'PRN'], suffixes=('_file1', '_file2'))
merged_smoothed_data_3x['difference_pseudorange'] = merged_smoothed_data_3x['pseudorange_file1'] - merged_smoothed_data_3x['pseudorange_file2'] - NORMALIZE_VALUE
merged_smoothed_data_3x['difference_carrier_phase'] = merged_smoothed_data_3x['carrier_phase_file1'] - merged_smoothed_data_3x['carrier_phase_file2'] - NORMALIZE_VALUE
...
merged_smoothed_data_3x_smooth['cosAlpha_avg'] =  ( merged_smoothed_data_3x_smooth['cosAlpha_file1'] + merged_smoothed_data_3x_smooth['cosAlpha_file2'] ) /2

# merged_smoothed_data_3x['cosAlpha_avg'] = ( merged_smoothed_data_3x['cosAlpha_file1'] + merged_smoothed_data_3x['cosAlpha_file2']) /2
# print(merged_smoothed_data_3x[0:32])

print('merged_smoothed_data_3x_smooth')
print(merged_smoothed_data_3x_smooth[0:32])
...
def calculate_double_difference_NDS2(merged_smoothed_data):
...
merged_smoothed_data_double_3x_smooth = calculate_double_difference_NDS2(merged_smoothed_data_3x_smooth)
    ...
    for reference_satellite in list_satellite:  # Duyệt qua tất cả các vệ tinh trong danh sách
        ...
        for satellite_diff in merged_smoothed_data_double['PRN_difference'].unique():
            if satellite_diff.startswith(reference_satellite):  # Lọc chỉ các vệ tinh bắt đầu từ reference_satellite
                ...
                plt.plot(satellite_diff_data['epoch'], satellite_diff_data[f'{key}'], label=satellite_diff)
    ...
    for reference_satellite in list_satellite:  # Duyệt qua tất cả các vệ tinh trong danh sách
        ...
        for satellite_diff in merged_smoothed_data_double['PRN_difference'].unique():
            if satellite_diff.startswith(reference_satellite):  # Lọc chỉ các vệ tinh bắt đầu từ reference_satellite
                # Lọc dữ liệu cho cặp vệ tinh
                satellite_diff_data = merged_smoothed_data_double[merged_smoothed_data_double['PRN_difference'] == satellite_diff]
                plt.plot(satellite_diff_data['epoch'], (satellite_diff_data[f'{key}'] + add ) * multi , label=satellite_diff)
...
# Fract_carrier_phase
plot_all_double_difference_comparisons_nds1(merged_smoothed_data_double_3x_smooth,'PLOT\external\D2025_03_13\carrier_phase_fract','fract_DD_CP','fract_DD_CP','fract_DD_CP')
plot_all_double_difference_comparisons_nds2(merged_smoothed_data_double_3x_smooth,'PLOT\external\D2025_03_13\carrier_phase_fract_add1','fract_DD_CP','fract_DD_CP_add1','fract_DD_CP', 1, 1) 
plot_all_double_difference_comparisons_nds2(merged_smoothed_data_double_3x_smooth,'PLOT\external\D2025_03_13\carrier_phase_fract_add2','fract_DD_CP','fract_DD_CP_add2','fract_DD_CP',2, 1)
plot_all_double_difference_comparisons_nds2(merged_smoothed_data_double_3x_smooth,'PLOT\external\D2025_03_13\carrier_phase_fract_sub1','fract_DD_CP','fract_DD_CP_sub1','fract_DD_CP',-1, 1)
plot_all_double_difference_comparisons_nds2(merged_smoothed_data_double_3x_smooth,'PLOT\external\D2025_03_13\carrier_phase_fract_sub2','fract_DD_CP','fract_DD_CP_sub2','fract_DD_CP',-2, 1)


plot_all_double_difference_comparisons_nds1(merged_smoothed_data_double_3x_smooth,'PLOT\external\D2025_03_13\deltaCosAlpha_pseudo','deltaCosAlpha_pseudo','deltaCosAlpha_pseudorange_smooth','deltaCosAlpha_pseu')


plot_all_double_difference_comparisons_nds1(merged_smoothed_data_double_3x_smooth,'PLOT\external\D2025_03_13\deltaCosAlpha_ephemeris','deltaCosAlpha_ephemeris','deltaCosAlpha_ephemeris','deltaCosAlpha_ephemeris')


plot_all_double_difference_comparisons_nds2(merged_smoothed_data_double_3x_smooth,'PLOT\external\D2025_03_13\D_multi_deltaCosAlpha_ephemeris','D_multi_deltaCosAlpha_ephemeris','D_multi_deltaCosAlpha_ephemeris','deltaCosAlpha_ephemeris',0 , D_rx1_rx2)
plot_all_double_difference_comparisons_nds2(merged_smoothed_data_double_3x_smooth,'PLOT\external\D2025_03_13\D_multi_frac_deltaCosAlpha_ephemeris','D_multi_frac_deltaCosAlpha_ephemeris','D_multi_frac_deltaCosAlpha_ephemeris','frac_deltaCosAlpha_ephemeris',0 , D_rx1_rx2)

plot_all_double_difference_comparisons_nds1(merged_smoothed_data_double_3x_smooth,'PLOT\external\D2025_03_13\deltaCosAlpha_ephemeris_fract','frac_deltaCosAlpha_ephemeris','frac_deltaCosAlpha_ephemeris','frac_deltaCosAlpha_ephemeris')
