...
if IS_CLOCK2 == 0:
    ...
    # observation_file_01_doppler = "DATA\external\D2025_03_13\96810723\convert_doppler\D20250720848_12M_01S_MO.rnx"

    nav_file_01 = "DATA\external\D2025_03_13\96810723\96810723.25N"
    observation_file_01 = "DATA\external\D2025_03_18\96810771\96810771.25O"
    observation_file_01_doppler = "DATA\external\D2025_03_13\96810723\convert_doppler\D20250720848_12M_01S_MO.rnx"
    ...
    observation_file_02 = "DATA\external\D2025_03_18\89680771\IGS000USA_R_20250771218_01D_01S_MO.rnx"
...
#Không sử dụng doppler
def read_rinex_observation_NGUYENDS3(file_path, isClock):
    """
    Đọc file RINEX và trích xuất dữ liệu cần thiết.
    Trả về DataFrame chứa: thời gian (epoch), số hiệu vệ tinh, và pseudorange.
    """
...
#Rinex 3.02
obs_data_01 = read_rinex_observation_NGUYENDS3(observation_file_01, IS_CLOCK2)
obs_data_02 = read_rinex_observation_NGUYENDS3(observation_file_02, IS_CLOCK2)
# obs_data_01 = read_rinex_observation_NguyenDS2(observation_file_01, observation_file_01_doppler, IS_CLOCK2)
# obs_data_02 = read_rinex_observation_NguyenDS2(observation_file_02, observation_file_02_doppler, IS_CLOCK2)


print(obs_data_01[0:30])
print(obs_data_02[0:30])
...
def calculate_azimuth_elevation(sat_pos, receiver_pos):
    ...
    cos_alpha = - (math.cos(math.radians(azimuth+58)) * math.cos(math.radians(elevation)))
...
plot_all_double_difference_comparisons_nds1(merged_smoothed_data_double_3x_smooth,'PLOT\external\D2025_03_18_doplerConvert\double_difference_pseudorange','double_difference_pseudorange','double_difference_pseudorange','double_difference_pseudorange')
plot_all_double_difference_comparisons_nds1(merged_smoothed_data_double_3x_smooth,'PLOT\external\D2025_03_18_doplerConvert\double_difference_carrier_phase','double_difference_carrier_phase','double_difference_carrier_phase','double_difference_carrier_phase')
plot_all_double_difference_comparisons_nds1(merged_smoothed_data_double_3x_smooth,'PLOT\external\D2025_03_18_doplerConvert\dfract_DD_CP','fract_DD_CP','fract_DD_CP','fract_DD_CP')
