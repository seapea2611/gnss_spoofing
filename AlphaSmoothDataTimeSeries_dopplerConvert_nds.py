...
def calculate_azimuth_elevation(sat_pos, receiver_pos):
    ...
    cos_alpha = - (math.cos(math.radians(azimuth+56)) * math.cos(math.radians(elevation)))
...
plot_all_double_difference_comparisons_nds1(merged_smoothed_data_double_3x_smooth,'PLOT\external\D2025_03_13_doplerConvert\double_difference_pseudorange2','double_difference_pseudorange','double_difference_pseudorange','double_difference_pseudorange')
